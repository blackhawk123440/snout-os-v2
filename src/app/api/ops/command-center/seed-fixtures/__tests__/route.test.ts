...
import { POST } from '@/app/api/ops/command-center/seed-fixtures/route';

describe('POST /api/ops/command-center/seed-fixtures', () => {
  it('returns 404 when runtime env is production', async () => {
    const req = new NextRequest('http://localhost/api/ops/command-center/seed-fixtures', {
      method: 'POST',
