/**
 * Routing History Route
 * 
 * GET /api/routing/threads/[id]/history
 * Proxies to NestJS API for routing history
 */
...
export async function GET(
  ...
  const apiUrl = `${API_BASE_URL}/api/routing/threads/${threadId}/history${searchParams ? `?${searchParams}` : ''}`;
  ...
  try {
    ...
    console.error('[BFF Proxy] Failed to forward routing history request:', error);
    return NextResponse.json(
